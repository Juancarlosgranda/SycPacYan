...
class DetalleNotaCreditoEmitidaController extends Controller {
	...
	*/
	...
	public function postCrear(CrearDetalleComprobanteRequest $request)
	{
		...
		{
			return redirect("/validado/detallenotacreditoemitida?comp_id={$comp_id}")->with('error','ESTE PRODUCTO YA EXISTE');
		}
		...
		else
		{
			...
			return redirect("/validado/detallenotacreditoemitida?comp_id={$comp_id}")->with('creado','Detalle Comprobante creado');
		}
	}
	...
	public function postEditar(EditarDetalleComprobanteRequest $request)
	{
		...
		return redirect("/validado/detallenotacreditoemitida?comp_id={$comp_id}")->with('actualizado','Detalle Comprobante actualizado');
	}
	...
	public function getEliminar(Request $request)
	{
		...
		return redirect('/validado/detallenotacreditoemitida')->with('eliminado','Detalle Comprobante eliminado');
	}
	...
	public function getGenerartxt(Request $request)
	{
		...
		return view('detallenotacreditoemitida.txt',['detallecomprobantes'=> $detallecomprobantes,'comprobante'=> $comprobante,'comprobante_ref'=> $comprobante_ref,'nro_correlativo'=>$nro_correlativo]);
	}
	...
	public function getRegresar(Request $request)
	{
		$this->validate($request,['comp_id'=>'required']);
		$comp_id=$request->get('comp_id');
		return redirect("/validado/detallenotacreditoemitida?comp_id={$comp_id}")->with('creado','SE GENERÓ .TXT');
	}
