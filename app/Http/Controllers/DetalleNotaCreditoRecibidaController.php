...
class DetalleNotaCreditoRecibidaController extends Controller {
	...
	*/
	...
	public function getIndex(Request $request)
	{
		...
		return view('detallenotacreditorecibida.mostrar',['detallecomprobantes'=> $detallecomprobantes,'comprobante'=> $comprobante,'moneda'=> $moneda]);
	}
	...
	public function getCrear(Request $request)
	{
		...
		return view('detallenotacreditorecibida.crear',['productos'=> $productos,'unidadmedidas'=> $unidadmedidas,'comp_id'=> $comp_id]);
	}
	...
	public function postCrear(CrearDetalleComprobanteRequest $request)
	{
		...
		{
			return redirect("/validado/detallenotacreditorecibida?comp_id={$comp_id}")->with('error','ESTE PRODUCTO YA EXISTE');
		}
		...
		else
		{
			...
			return redirect("/validado/detallenotacreditorecibida?comp_id={$comp_id}")->with('creado','Detalle Comprobante creado');
		}
	}
	...
	public function getEditar(Request $request)
	{
		...
		return view('detallenotacreditorecibida.editar',['detallecomprobante'=>$detallecomprobante,'productos'=>$productos,'unidadmedidas'=>$unidadmedidas]);
	...
	public function postEditar(EditarDetalleComprobanteRequest $request)
	{
		...
		return redirect("/validado/detallenotacreditorecibida?comp_id={$comp_id}")->with('actualizado','Detalle Comprobante actualizado');
	}
	...
	public function getEliminar(Request $request)
	{
		...
		return redirect('/validado/detallenotacreditorecibida')->with('eliminado','Detalle Comprobante eliminado');
	}
	...
	public function getImprimir(Request $request)
	{
		...
		if($comprobante->tipocomprobante->tcomp_desc=='Boleta')
			return view('detallenotacreditorecibida.imprimirboleta',['detallecomprobantes'=> $detallecomprobantes,'comprobante'=> $comprobante,'moneda'=> $moneda]);
		else
			return view('detallenotacreditorecibida.imprimirfactura',['detallecomprobantes'=> $detallecomprobantes,'comprobante'=> $comprobante,'moneda'=> $moneda]);
	}
	...
	public function getGenerartxt(Request $request)
	{
		...
		return view('detallenotacreditorecibida.txt',['detallecomprobantes'=> $detallecomprobantes,'comprobante'=> $comprobante,'comprobante_ref'=> $comprobante_ref,'nro_correlativo'=>$nro_correlativo]);
	}
	...
	public function getRegresar(Request $request)
	{
		$this->validate($request,['comp_id'=>'required']);
		$comp_id=$request->get('comp_id');
		return redirect("/validado/detallenotacreditorecibida?comp_id={$comp_id}")->with('creado','SE GENERÓ .TXT');
	}
