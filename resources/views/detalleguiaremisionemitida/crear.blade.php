		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/validado/detalleguiaremisionemitida/crear">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Peso Total</label>
							<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" disabled="" class="form-control text-uppercase" value="{{$comprobante->adicionalguia->unidad->uni_desc}}">
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								...
								<a href="/validado/detalleguiaremisionemitida?comp_id={{$comp_id}}" class="btn btn-danger" role="button">Cancelar</a>
							</div>
						</div>
					</form>
				</div>
